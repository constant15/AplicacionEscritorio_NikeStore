    ...
    public partial class frmProveedores : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (objProveedor.IdProveedor == 0)
            {
                ...
                {
                    dgvData.Rows.Add(new object[] { "", idProveedorGenerado, txtDocumento.Text, txtRazonSocial.Text, txtCorreo.Text, txtCelular.Text,
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                savefile.FileName = string.Format("ReporteProveedores-{0}.xlsx", DateTime.Now.ToString("ddMMyyyyHHmmss"));
                ...
                if (savefile.ShowDialog() == DialogResult.OK)
                {
                    try
                    {
                        ...
                        MessageBox.Show("Reporte de proveedores generado con exito.", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    catch
                    {
