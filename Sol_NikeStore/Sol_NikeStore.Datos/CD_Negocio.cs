...
namespace Sol_NikeStore.Datos
{
    public class CD_Negocio
    {
        public NegocioBis ObtenerDatos()
        {
            ...
            try
            {
                ...
                using (SqlConnection conexion = new SqlConnection(Conexion.cadena))
                {
                    ...
                    string query = "select IdNegocio, NombreNegocio, Rut, Direccion from NEGOCIO where IdNegocio = 1";
        ...
        public bool GuardarDatos(NegocioBis objeto, out string mensaje)
        {
            ...
            try
            {
                ...
                using (SqlConnection conexion = new SqlConnection(Conexion.cadena))
                {
                    ...
                    query.AppendLine("update NEGOCIO set NombreNegocio = @nombrenegocio,");
