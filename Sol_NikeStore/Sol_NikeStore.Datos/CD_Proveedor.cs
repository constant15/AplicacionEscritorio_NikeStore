...
namespace Sol_NikeStore.Datos
{
    ...
    {
        //Metodo para listar todos los Proveedors almacenados en la base de datos 
        public List<Proveedor> Listar()
        {
            ...
            using (SqlConnection oconexion = new SqlConnection(Conexion.cadena))
            {
                ...
                {
                    //Si hay un error, que liste un Proveedor vacio
        ...
        //Metodo que se conecta a la base de datos y registra un Proveedor en ella desde la interfaz del programa
        ...
        //Metodo que se conecta a la base de datos y edita un Proveedor en ella desde la interfaz del programa
