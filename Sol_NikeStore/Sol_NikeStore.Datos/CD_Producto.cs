...
namespace Sol_NikeStore.Datos
{
    ...
    {
        //Metodo para listar todos los Productos almacenados en la base de datos 
        public List<Producto> Listar()
        {
            ...
            using (SqlConnection oconexion = new SqlConnection(Conexion.cadena))
            {
                ...
                {
                    //Si hay un error, que liste un Producto vacio
        ...
        //Metodo que se conecta a la base de datos y registra un Producto en ella desde la interfaz del programa
        ...
        //Metodo que se conecta a la base de datos y edita un Producto en ella desde la interfaz del programa
